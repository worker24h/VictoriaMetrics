...
var (
	...
	maxQueryDuration = flag.Duration("search.maxQueryDuration", time.Second*3000, "The maximum duration for query execution. It can be overridden to a smaller value on a per-query basis via 'timeout' query arg")
)
